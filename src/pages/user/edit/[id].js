            ...
            <Grid container spacing={6}>
              <Grid item xs={12} sm={6}>
                <FormControl error={error.name && 'true'} fullWidth>
                  ...
                  <OutlinedInput value={dataUser.name} onChange={e => handleForm(e)} id='name' label='Nama Lengkap' />
                  {error.name && (
                    <FormHelperText sx={{ color: 'error.main', marginTop: 2 }}>{error.name}</FormHelperText>
                  )}
                </FormControl>
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth>
                  ...
                  <OutlinedInput value={dataUser.nik} readOnly label='NOMOR INDUK KEPENDUDUKAN' />
                </FormControl>
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth>
                  ...
                  <OutlinedInput value={dataUser.nomor_anggota} readOnly label='Nomor Anggota' />
                </FormControl>
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl error={error.email && 'true'} fullWidth>
                  ...
                  <OutlinedInput onChange={e => handleForm(e)} id='email' value={dataUser.email} label='Email' />
                  {error.email && (
                    <FormHelperText sx={{ color: 'error.main', marginTop: 2 }}>{error.email}</FormHelperText>
                  )}
                </FormControl>
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl error={error.no_hp && 'true'} fullWidth>
                  ...
                  <OutlinedInput onChange={e => handleForm(e)} id='no_hp' value={dataUser.no_hp} label='Nomor Telpon' />
                  {error.no_hp && (
                    <FormHelperText sx={{ color: 'error.main', marginTop: 2 }}>{error.no_hp}</FormHelperText>
                  )}
                </FormControl>
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl error={error.jabatan && 'true'} fullWidth>
                  ...
                  <OutlinedInput value={dataUser.jabatan} id='jabatan' onChange={e => handleForm(e)} label='Jabatan' />
                  {error.jabatan && (
                    <FormHelperText sx={{ color: 'error.main', marginTop: 2 }}>{error.jabatan}</FormHelperText>
                  )}
                </FormControl>
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl error={error.jenis_pengurus && 'true'} fullWidth>
                  ...
                  {error.jenis_pengurus && (
                    <FormHelperText sx={{ color: 'error.main', marginTop: 2 }}>{error.jenis_pengurus}</FormHelperText>
                  )}
                </FormControl>
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl error={error.tempat_lahir && 'true'} fullWidth>
                  ...
                  />
                  {error.tempat_lahir && (
                    <FormHelperText sx={{ color: 'error.main', marginTop: 2 }}>{error.tempat_lahir}</FormHelperText>
                  )}
                </FormControl>
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl error={error.tanggal_lahir && 'true'} fullWidth>
                  ...
                  {error.tanggal_lahir && (
                    <FormHelperText sx={{ color: 'error.main', marginTop: 2 }}>{error.tanggal_lahir}</FormHelperText>
                  )}
                </FormControl>
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl error={error.provinsi && 'true'} fullWidth>
                  ...
                  <Select
                    ...
                    label='Provinsi'
                    onChange={e => [
                      handleChangeSelect(e, 'provinsi'),
                      handleChangeProvinsi(e),
                  ...
                  {error.provinsi && (
                    <FormHelperText sx={{ color: 'error.main', marginTop: 2 }}>{error.provinsi}</FormHelperText>
                  )}
                </FormControl>
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl error={error.kota && 'true'} fullWidth>
                  ...
                  {error.kota && (
                    <FormHelperText sx={{ color: 'error.main', marginTop: 2 }}>{error.kota}</FormHelperText>
                  )}
                </FormControl>
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl error={error.kecamatan && 'true'} fullWidth>
                  ...
                  {error.kecamatan && (
                    <FormHelperText sx={{ color: 'error.main', marginTop: 2 }}>{error.kecamatan}</FormHelperText>
                  )}
                </FormControl>
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl error={error.kelurahan && 'true'} fullWidth>
                  ...
                  {error.kelurahan && (
                    <FormHelperText sx={{ color: 'error.main', marginTop: 2 }}>{error.kelurahan}</FormHelperText>
                  )}
                </FormControl>
              </Grid>
              ...
              <Grid item xs={12} sm={12}>
                <FormControl error={error.alamat_lengkap && 'true'} fullWidth>
                  ...
                  {error.alamat_lengkap && (
                    <FormHelperText sx={{ color: 'error.main', marginTop: 2 }}>{error.alamat_lengkap}</FormHelperText>
                  )}
                </FormControl>
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl error={error.jenis_hp && 'true'} fullWidth>
                  ...
                  {error.jenis_hp && (
                    <FormHelperText sx={{ color: 'error.main', marginTop: 2 }}>{error.jenis_hp}</FormHelperText>
                  )}
                </FormControl>
              </Grid>
                  ...
                  <FormGroup row onChange={e => handleCheckBox(e)}>
                    {wallets.map(wallet => (
                      <FormControlLabel
                        ...
                        control={
                          <Checkbox
                            defaultChecked={dompetDigital && dompetDigital.find(dompet => dompet == wallet) && 'true'}
                          />
                        }
                        label={wallet}
                        key={wallet}
