...
useEffect(() => {
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h4' sx={{ mb:4 }}>Register All</Typography>
        <Card>
        <CardHeader />
          <CardContent>
            <Grid container spacing={1}>
              ...
              <Grid sx={{  mr:2, mt:4 }}>
                <LocalizationProvider  dateAdapter={AdapterDayjs} >
                    ...
                    renderInput={(params) => <TextField readOnly size="small" {...params} />}
                    />
              ...
              <Grid item sm={4} xs={12}>
                ...
                <Button sx={{ mb: 2, mt:3 }} color='error' size='large' variant='contained' onClick={handleResetFilter}>
                    <RestartAltIcon/>
                </Button>
              </Grid>
            </Grid>
