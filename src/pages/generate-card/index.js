  ...
  return (
    ...
    <Box sx={{ flexGrow: 2 }} style={{ width:"500px" }} id="kartu-anggota">
      ...
      style={{  
        ...
        <Typography variant="h6" display="block" sx={{ mt:2, letterSpacing: 4 }} style={{ fontSize:12 }} color="#fff">
            KARTU TANDA ANGGOTA
        </Typography>
    ...
    style={{ 
        ...
        style={{ 
            ...
            >
                <Typography variant="h6" display="block" sx={{ mt:2, letterSpacing: 4 }} style={{ fontSize:18, fontWeight:"bold" }} color="#fff">
                    {dataUser.name}
                </Typography>
            </Grid>
            <Grid
    ...
    style={{ 
        ...
        <Button onClick={handleCaptureClick} variant="contained">Download Kartu</Button>
    </Grid>
    </Box>
  );
}
