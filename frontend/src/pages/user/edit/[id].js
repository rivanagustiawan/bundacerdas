...
const Edit = ({id}) => {
  ...
  function handleCheckBox(e){
    const newDataUser = {...dataUser}
    newDataUser['dompet_digital'] = newDataUser['dompet_digital'] + ','+ e.target.value
    setDataUser(newDataUser)
  }
          ...
          <CardContent>
            ...
            <form onSubmit={handleSubmit}>
              <Grid container spacing={6}>
                ...
                <Grid item xs={12} sm={12}>
                  ...
                  <FormGroup
                    ...
                    >
                      {
                        wallets.map(wallet => (
                          <FormControlLabel value={wallet} control={<Checkbox checked={
                            dompetDigital &&
                ...
                <Grid item xs={12}>
                  <Button type='button' variant='contained' sx={{ mr:4 }}>
                    Kembali
                  </Button>
